...
const MailCard = ({ section }) => {
  return (
    <motion.a
      href="mailto:alessandro.ariaw@gmail.com"
      target="_blank"
      rel="noreferrer"
      animate={{ opacity: ["all", "contact"].includes(section) ? 1 : 0.3 }}
      className="rounded-3xl bg-[#98CFFF] dark:saturate-150 dark:brightness-50 flex justify-center items-center col-span-1 relative"
